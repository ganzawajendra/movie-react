...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      {/* Footer */}
      <footer className="bg-manual-dark text-white py-4 text-center px-40">
        <div className="flex justify-center items-center mb-2 w-30 flex-col">
          <img src="./img/logoMerah.png" alt="Logo Moflix" />
          <p className="mt-2 font-montserrat-light tracking-wide">Moflix</p>
        </div>
        <p className="text-sm">© 2023 Moflix. All rights reserved.</p>
      </footer>
    </div>
  );
};
