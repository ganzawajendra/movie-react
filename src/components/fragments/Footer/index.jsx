  ...
  return (
    <div className={` ${sticky ? 'w-full z-1 sticky bottom-0' : ''}`}>
      ...
      sm:px-10">
        <div className="grid grid-cols-3 gap-10">
          <div className="flex flex-col items-center justify-center">
            <img src="/img/logoMerah.png" alt="Logo Moflix" className="transition-all duration-300 lg:w-30 md:w-25 sm:w-20" />
          ...
          <div className="flex flex-col items-start justify-start">
            ...
            sm:text-xs">
              ...
              lg:text-sm
              md:text-sm
              sm:text-xs">lorem@gmail.com</span>
            </p>
      ...
      sm:py-2">
        ...
        lg:text-sm
        md:text-sm
        sm:text-xs">© Lorem ipsum dolor sit amet.</p>
      </div>
    </div>
  );
};
